...
- Доработка участника 2: объяснения до 280 символов, проверенная дата и цитаты о конкретном опыте, масштабе и услугах. Версия `ranking-v7:evidence-v3:fallback-v2` автоматически входит в ключ кэша. Ограничение цитат и отдельная рубрика качества проверяются 52 локальными тестами и реальными AI-сценариями. [Актуальный AI-отчёт](AI_EVALUATION.md).
